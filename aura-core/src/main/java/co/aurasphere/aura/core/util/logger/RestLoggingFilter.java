package co.aurasphere.aura.core.util.logger;
...
/**
 * Filter which logs request, response and other data for HTTP web services.
...
public class RestLoggingFilter implements Filter {
	...
	private static final Logger log = LoggerFactory.getLogger("aura-rest");
